...
class Automation:
    ...
    def getVideoProperties(self, dirpath, filename, cleanFileName):
        ...
        new_image_filepath = os.path.join(thumbnails_dir,f"{cleanFileName}.jpg")
    ...
    def Automate(self, path:str) -> int:
        fileCount = 0
        for dirpath, dirs, files in os.walk(path):
            for filename in files:
                ...
                fps, nframes, duration, dimensions = self.getVideoProperties(dirpath, filename, newFileName)
                ...
                print(fileCount, videoID, channel);
